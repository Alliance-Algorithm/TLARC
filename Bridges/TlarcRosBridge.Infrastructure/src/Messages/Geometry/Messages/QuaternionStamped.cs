...
namespace TlarcRosBridge.Infrastructure.Messages.Geometry
{
    ...
    public unsafe partial class QuaternionStamped : global::Rosidl.Runtime.IMessage
    {
        ...
        public QuaternionStamped(
            ...
            global::TlarcRosBridge.Infrastructure.Messages.Geometry.Quaternion? @quaternion = null
        )
        {
            Header = @header ?? new global::TlarcRosBridge.Infrastructure.Messages.Std.Header();
            Quaternion = @quaternion ?? new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Quaternion();
        }
        ...
        public QuaternionStamped(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Quaternion = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Quaternion(in priv.Quaternion, textEncoding);
        }
        ...
        public QuaternionStamped()
        {
            ...
            Quaternion = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Quaternion();
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.4.0+866072750999979fa04a21d1d2f84d5346ef2c35")]
        public global::TlarcRosBridge.Infrastructure.Messages.Geometry.Quaternion Quaternion { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Quaternion quaternion]]></c>
            /// </summary>
            public global::TlarcRosBridge.Infrastructure.Messages.Geometry.Quaternion.Priv Quaternion;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Geometry.QuaternionStamped.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Geometry.QuaternionStamped.PrivSequence.{caller}'.");
                }
            }
        }
    }
