...
namespace TlarcRosBridge.Infrastructure.Messages.Geometry
{
    ...
    public unsafe partial class PolygonStamped : global::Rosidl.Runtime.IMessage
    {
        ...
        public PolygonStamped(
            ...
            global::TlarcRosBridge.Infrastructure.Messages.Geometry.Polygon? @polygon = null
        )
        {
            Header = @header ?? new global::TlarcRosBridge.Infrastructure.Messages.Std.Header();
            Polygon = @polygon ?? new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Polygon();
        }
        ...
        public PolygonStamped(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Polygon = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Polygon(in priv.Polygon, textEncoding);
        }
        ...
        public PolygonStamped()
        {
            ...
            Polygon = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Polygon();
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.4.0+866072750999979fa04a21d1d2f84d5346ef2c35")]
        public global::TlarcRosBridge.Infrastructure.Messages.Geometry.Polygon Polygon { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Polygon polygon]]></c>
            /// </summary>
            public global::TlarcRosBridge.Infrastructure.Messages.Geometry.Polygon.Priv Polygon;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Geometry.PolygonStamped.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Geometry.PolygonStamped.PrivSequence.{caller}'.");
                }
            }
        }
    }
