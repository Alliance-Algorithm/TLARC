...
namespace TlarcRosBridge.Infrastructure.Messages.Geometry
{
    ...
    public unsafe partial class PointStamped : global::Rosidl.Runtime.IMessage
    {
        ...
        public PointStamped(
            ...
            global::TlarcRosBridge.Infrastructure.Messages.Geometry.Point? @point = null
        )
        {
            Header = @header ?? new global::TlarcRosBridge.Infrastructure.Messages.Std.Header();
            Point = @point ?? new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Point();
        }
        ...
        public PointStamped(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Point = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Point(in priv.Point, textEncoding);
        }
        ...
        public PointStamped()
        {
            ...
            Point = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Point();
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.4.0+866072750999979fa04a21d1d2f84d5346ef2c35")]
        public global::TlarcRosBridge.Infrastructure.Messages.Geometry.Point Point { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Point point]]></c>
            /// </summary>
            public global::TlarcRosBridge.Infrastructure.Messages.Geometry.Point.Priv Point;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Geometry.PointStamped.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Geometry.PointStamped.PrivSequence.{caller}'.");
                }
            }
        }
    }
