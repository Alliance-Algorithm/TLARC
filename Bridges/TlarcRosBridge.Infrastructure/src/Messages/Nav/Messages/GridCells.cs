...
namespace TlarcRosBridge.Infrastructure.Messages.Nav
{
    ...
    public unsafe partial class GridCells : global::Rosidl.Runtime.IMessage
    {
        ...
        public GridCells(
            ...
            float @cellWidth = 0f,
            float @cellHeight = 0f,
            global::TlarcRosBridge.Infrastructure.Messages.Geometry.Point[]? @cells = null
        )
        {
            Header = @header ?? new global::TlarcRosBridge.Infrastructure.Messages.Std.Header();
            CellWidth = @cellWidth;
            CellHeight = @cellHeight;
            Cells = @cells ?? global::System.Array.Empty<global::TlarcRosBridge.Infrastructure.Messages.Geometry.Point>();
        }
        ...
        public GridCells(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Cells = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Point[priv.Cells.Size];
            var Cells_span = priv.Cells.AsSpan();
            for (int __i = 0; __i < this.Cells.Length; __i++)
            {
                this.Cells[__i] = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Point(in Cells_span[__i], textEncoding);
            }
        }
        ...
        public GridCells()
        {
            ...
            CellWidth = 0f;
            CellHeight = 0f;
            Cells = global::System.Array.Empty<global::TlarcRosBridge.Infrastructure.Messages.Geometry.Point>();
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.4.0+866072750999979fa04a21d1d2f84d5346ef2c35")]
        public global::TlarcRosBridge.Infrastructure.Messages.Geometry.Point[] Cells { get; set; }
        ...
        public void WriteTo(ref Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            priv.Cells = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Point.PrivSequence(this.Cells.Length);
            var Cells_span = priv.Cells.AsSpan();
            for (int __i = 0; __i < this.Cells.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Point[] cells]]></c>
            /// </remarks>
            public global::TlarcRosBridge.Infrastructure.Messages.Geometry.Point.PrivSequence Cells;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Nav.GridCells.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Nav.GridCells.PrivSequence.{caller}'.");
                }
            }
        }
    }
