...
namespace TlarcRosBridge.Infrastructure.Messages.Nav
{
    ...
    public unsafe partial class Path : global::Rosidl.Runtime.IMessage
    {
        ...
        public Path(
            ...
            global::TlarcRosBridge.Infrastructure.Messages.Geometry.PoseStamped[]? @poses = null
        )
        {
            Header = @header ?? new global::TlarcRosBridge.Infrastructure.Messages.Std.Header();
            Poses = @poses ?? global::System.Array.Empty<global::TlarcRosBridge.Infrastructure.Messages.Geometry.PoseStamped>();
        }
        ...
        public Path(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Poses = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.PoseStamped[priv.Poses.Size];
            var Poses_span = priv.Poses.AsSpan();
            for (int __i = 0; __i < this.Poses.Length; __i++)
            {
                this.Poses[__i] = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.PoseStamped(in Poses_span[__i], textEncoding);
            }
        }
        ...
        public Path()
        {
            ...
            Poses = global::System.Array.Empty<global::TlarcRosBridge.Infrastructure.Messages.Geometry.PoseStamped>();
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.4.0+866072750999979fa04a21d1d2f84d5346ef2c35")]
        public global::TlarcRosBridge.Infrastructure.Messages.Geometry.PoseStamped[] Poses { get; set; }
        ...
        public void WriteTo(ref Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            priv.Poses = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.PoseStamped.PrivSequence(this.Poses.Length);
            var Poses_span = priv.Poses.AsSpan();
            for (int __i = 0; __i < this.Poses.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/PoseStamped[] poses]]></c>
            /// </remarks>
            public global::TlarcRosBridge.Infrastructure.Messages.Geometry.PoseStamped.PrivSequence Poses;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Nav.Path.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Nav.Path.PrivSequence.{caller}'.");
                }
            }
        }
    }
