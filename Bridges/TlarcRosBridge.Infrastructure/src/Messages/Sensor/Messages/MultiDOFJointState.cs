...
namespace TlarcRosBridge.Infrastructure.Messages.Sensor
{
    /// <summary>
    ...
    public unsafe partial class MultiDOFJointState : global::Rosidl.Runtime.IMessage
    {
        ...
        public MultiDOFJointState(
            ...
            global::TlarcRosBridge.Infrastructure.Messages.Geometry.Transform[]? @transforms = null,
            global::TlarcRosBridge.Infrastructure.Messages.Geometry.Twist[]? @twist = null,
            global::TlarcRosBridge.Infrastructure.Messages.Geometry.Wrench[]? @wrench = null
        )
        {
            ...
            Transforms = @transforms ?? global::System.Array.Empty<global::TlarcRosBridge.Infrastructure.Messages.Geometry.Transform>();
            Twist = @twist ?? global::System.Array.Empty<global::TlarcRosBridge.Infrastructure.Messages.Geometry.Twist>();
            Wrench = @wrench ?? global::System.Array.Empty<global::TlarcRosBridge.Infrastructure.Messages.Geometry.Wrench>();
        }
        ...
        public MultiDOFJointState(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Transforms = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Transform[priv.Transforms.Size];
            var Transforms_span = priv.Transforms.AsSpan();
            for (int __i = 0; __i < this.Transforms.Length; __i++)
            {
                this.Transforms[__i] = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Transform(in Transforms_span[__i], textEncoding);
            }
        
            this.Twist = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Twist[priv.Twist.Size];
            var Twist_span = priv.Twist.AsSpan();
            for (int __i = 0; __i < this.Twist.Length; __i++)
            {
                this.Twist[__i] = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Twist(in Twist_span[__i], textEncoding);
            }
        
            this.Wrench = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Wrench[priv.Wrench.Size];
            var Wrench_span = priv.Wrench.AsSpan();
            for (int __i = 0; __i < this.Wrench.Length; __i++)
            {
                this.Wrench[__i] = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Wrench(in Wrench_span[__i], textEncoding);
            }
        }
        ...
        public MultiDOFJointState()
        {
            ...
            Transforms = global::System.Array.Empty<global::TlarcRosBridge.Infrastructure.Messages.Geometry.Transform>();
            Twist = global::System.Array.Empty<global::TlarcRosBridge.Infrastructure.Messages.Geometry.Twist>();
            Wrench = global::System.Array.Empty<global::TlarcRosBridge.Infrastructure.Messages.Geometry.Wrench>();
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.4.0+866072750999979fa04a21d1d2f84d5346ef2c35")]
        public global::TlarcRosBridge.Infrastructure.Messages.Geometry.Transform[] Transforms { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.4.0+866072750999979fa04a21d1d2f84d5346ef2c35")]
        public global::TlarcRosBridge.Infrastructure.Messages.Geometry.Twist[] Twist { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.4.0+866072750999979fa04a21d1d2f84d5346ef2c35")]
        public global::TlarcRosBridge.Infrastructure.Messages.Geometry.Wrench[] Wrench { get; set; }
        ...
        public void WriteTo(ref Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            priv.Transforms = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Transform.PrivSequence(this.Transforms.Length);
            var Transforms_span = priv.Transforms.AsSpan();
            for (int __i = 0; __i < this.Transforms.Length; __i++)
            {
            ...
            priv.Twist = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Twist.PrivSequence(this.Twist.Length);
            var Twist_span = priv.Twist.AsSpan();
            for (int __i = 0; __i < this.Twist.Length; __i++)
            {
            ...
            priv.Wrench = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.Wrench.PrivSequence(this.Wrench.Length);
            var Wrench_span = priv.Wrench.AsSpan();
            for (int __i = 0; __i < this.Wrench.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Transform[] transforms]]></c>
            /// </summary>
            public global::TlarcRosBridge.Infrastructure.Messages.Geometry.Transform.PrivSequence Transforms;
            
            /// <summary>
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Twist[] twist]]></c>
            /// </summary>
            public global::TlarcRosBridge.Infrastructure.Messages.Geometry.Twist.PrivSequence Twist;
            
            /// <summary>
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Wrench[] wrench]]></c>
            /// </summary>
            public global::TlarcRosBridge.Infrastructure.Messages.Geometry.Wrench.PrivSequence Wrench;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Sensor.MultiDOFJointState.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Sensor.MultiDOFJointState.PrivSequence.{caller}'.");
                }
            }
        }
    }
