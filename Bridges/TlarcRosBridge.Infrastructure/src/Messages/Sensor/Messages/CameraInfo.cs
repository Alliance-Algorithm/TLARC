...
namespace TlarcRosBridge.Infrastructure.Messages.Sensor
{
    ...
    public unsafe partial class CameraInfo : global::Rosidl.Runtime.IMessage
    {
        ...
        public CameraInfo(
            ...
            uint @binningX = 0,
            uint @binningY = 0,
            global::TlarcRosBridge.Infrastructure.Messages.Sensor.RegionOfInterest? @roi = null
        )
        {
            ...
            BinningX = @binningX;
            BinningY = @binningY;
            Roi = @roi ?? new global::TlarcRosBridge.Infrastructure.Messages.Sensor.RegionOfInterest();
        }
        ...
        public CameraInfo(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Roi = new global::TlarcRosBridge.Infrastructure.Messages.Sensor.RegionOfInterest(in priv.Roi, textEncoding);
        }
        ...
        public CameraInfo()
        {
            ...
            BinningX = 0;
            BinningY = 0;
            Roi = new global::TlarcRosBridge.Infrastructure.Messages.Sensor.RegionOfInterest();
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.4.0+866072750999979fa04a21d1d2f84d5346ef2c35")]
        public global::TlarcRosBridge.Infrastructure.Messages.Sensor.RegionOfInterest Roi { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            public global::System.Span<double> K
            {
                get
                {
                    fixed (global::TlarcRosBridge.Infrastructure.Messages.Sensor.CameraInfo.Priv* __p = &this) return new (__p->__K, 9);
                }
            }
            ...
            public global::System.Span<double> R
            {
                get
                {
                    fixed (global::TlarcRosBridge.Infrastructure.Messages.Sensor.CameraInfo.Priv* __p = &this) return new (__p->__R, 9);
                }
            }
            ...
            public global::System.Span<double> P
            {
                get
                {
                    fixed (global::TlarcRosBridge.Infrastructure.Messages.Sensor.CameraInfo.Priv* __p = &this) return new (__p->__P, 12);
                }
            }
            ...
            /// Originally defined as: <c><![CDATA[sensor_msgs/msg/RegionOfInterest roi]]></c>
            /// </remarks>
            public global::TlarcRosBridge.Infrastructure.Messages.Sensor.RegionOfInterest.Priv Roi;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Sensor.CameraInfo.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Sensor.CameraInfo.PrivSequence.{caller}'.");
                }
            }
        }
    }
