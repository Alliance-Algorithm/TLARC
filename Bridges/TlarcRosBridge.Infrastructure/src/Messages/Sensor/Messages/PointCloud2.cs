...
namespace TlarcRosBridge.Infrastructure.Messages.Sensor
{
    ...
    public unsafe partial class PointCloud2 : global::Rosidl.Runtime.IMessage
    {
        ...
        public PointCloud2(
            ...
            uint @height = 0,
            uint @width = 0,
            global::TlarcRosBridge.Infrastructure.Messages.Sensor.PointField[]? @fields = null,
        ...
        )
        {
            ...
            Height = @height;
            Width = @width;
            Fields = @fields ?? global::System.Array.Empty<global::TlarcRosBridge.Infrastructure.Messages.Sensor.PointField>();
        ...
        public PointCloud2(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Fields = new global::TlarcRosBridge.Infrastructure.Messages.Sensor.PointField[priv.Fields.Size];
            var Fields_span = priv.Fields.AsSpan();
            for (int __i = 0; __i < this.Fields.Length; __i++)
            {
                this.Fields[__i] = new global::TlarcRosBridge.Infrastructure.Messages.Sensor.PointField(in Fields_span[__i], textEncoding);
            }
        ...
        public PointCloud2()
        {
            ...
            Height = 0;
            Width = 0;
            Fields = global::System.Array.Empty<global::TlarcRosBridge.Infrastructure.Messages.Sensor.PointField>();
            IsBigendian = false;
            PointStep = 0;
            RowStep = 0;
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.4.0+866072750999979fa04a21d1d2f84d5346ef2c35")]
        public global::TlarcRosBridge.Infrastructure.Messages.Sensor.PointField[] Fields { get; set; }
        ...
        public void WriteTo(ref Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            priv.Fields = new global::TlarcRosBridge.Infrastructure.Messages.Sensor.PointField.PrivSequence(this.Fields.Length);
            var Fields_span = priv.Fields.AsSpan();
            for (int __i = 0; __i < this.Fields.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[sensor_msgs/msg/PointField[] fields]]></c>
            /// </remarks>
            public global::TlarcRosBridge.Infrastructure.Messages.Sensor.PointField.PrivSequence Fields;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Sensor.PointCloud2.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Sensor.PointCloud2.PrivSequence.{caller}'.");
                }
            }
        }
    }
