...
namespace TlarcRosBridge.Infrastructure.Messages.Sensor
{
    ...
    public unsafe partial class NavSatFix : global::Rosidl.Runtime.IMessage
    {
        ...
        public NavSatFix(
            ...
            global::TlarcRosBridge.Infrastructure.Messages.Sensor.NavSatStatus? @status = null,
            double @latitude = 0d,
            double @longitude = 0d,
            double @altitude = 0d,
        ...
        )
        {
            ...
            Status = @status ?? new global::TlarcRosBridge.Infrastructure.Messages.Sensor.NavSatStatus();
            Latitude = @latitude;
            Longitude = @longitude;
            Altitude = @altitude;
        ...
        public NavSatFix(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Status = new global::TlarcRosBridge.Infrastructure.Messages.Sensor.NavSatStatus(in priv.Status, textEncoding);
        ...
        public NavSatFix()
        {
            ...
            Status = new global::TlarcRosBridge.Infrastructure.Messages.Sensor.NavSatStatus();
            Latitude = 0d;
            Longitude = 0d;
            Altitude = 0d;
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.4.0+866072750999979fa04a21d1d2f84d5346ef2c35")]
        public global::TlarcRosBridge.Infrastructure.Messages.Sensor.NavSatStatus Status { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[sensor_msgs/msg/NavSatStatus status]]></c>
            /// </remarks>
            public global::TlarcRosBridge.Infrastructure.Messages.Sensor.NavSatStatus.Priv Status;
            ...
            public global::System.Span<double> PositionCovariance
            {
                get
                {
                    fixed (global::TlarcRosBridge.Infrastructure.Messages.Sensor.NavSatFix.Priv* __p = &this) return new (__p->__PositionCovariance, 9);
                }
            }
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Sensor.NavSatFix.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Sensor.NavSatFix.PrivSequence.{caller}'.");
                }
            }
        }
    }
