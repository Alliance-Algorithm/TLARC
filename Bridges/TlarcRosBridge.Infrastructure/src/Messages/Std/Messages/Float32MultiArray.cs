...
namespace TlarcRosBridge.Infrastructure.Messages.Std
{
    ...
    public unsafe partial class Float32MultiArray : global::Rosidl.Runtime.IMessage
    {
        ...
        public Float32MultiArray(
            global::TlarcRosBridge.Infrastructure.Messages.Std.MultiArrayLayout? @layout = null,
            float[]? @data = null
        )
        {
            Layout = @layout ?? new global::TlarcRosBridge.Infrastructure.Messages.Std.MultiArrayLayout();
        ...
        {
            this.Layout = new global::TlarcRosBridge.Infrastructure.Messages.Std.MultiArrayLayout(in priv.Layout, textEncoding);
        ...
        public Float32MultiArray()
        {
            Layout = new global::TlarcRosBridge.Infrastructure.Messages.Std.MultiArrayLayout();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.4.0+866072750999979fa04a21d1d2f84d5346ef2c35")]
        public global::TlarcRosBridge.Infrastructure.Messages.Std.MultiArrayLayout Layout { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[std_msgs/msg/MultiArrayLayout layout]]></c>
            /// </remarks>
            public global::TlarcRosBridge.Infrastructure.Messages.Std.MultiArrayLayout.Priv Layout;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Std.Float32MultiArray.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Std.Float32MultiArray.PrivSequence.{caller}'.");
                }
            }
        }
    }
