...
namespace TlarcRosBridge.Infrastructure.Messages.Std
{
    /// <summary>
    ...
    public unsafe partial class MultiArrayLayout : global::Rosidl.Runtime.IMessage
    {
        ...
        public MultiArrayLayout(
            global::TlarcRosBridge.Infrastructure.Messages.Std.MultiArrayDimension[]? @dim = null,
            uint @dataOffset = 0
        )
        {
            Dim = @dim ?? global::System.Array.Empty<global::TlarcRosBridge.Infrastructure.Messages.Std.MultiArrayDimension>();
        ...
        {
            this.Dim = new global::TlarcRosBridge.Infrastructure.Messages.Std.MultiArrayDimension[priv.Dim.Size];
            var Dim_span = priv.Dim.AsSpan();
            for (int __i = 0; __i < this.Dim.Length; __i++)
            {
                this.Dim[__i] = new global::TlarcRosBridge.Infrastructure.Messages.Std.MultiArrayDimension(in Dim_span[__i], textEncoding);
            }
        ...
        public MultiArrayLayout()
        {
            Dim = global::System.Array.Empty<global::TlarcRosBridge.Infrastructure.Messages.Std.MultiArrayDimension>();
            DataOffset = 0;
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.4.0+866072750999979fa04a21d1d2f84d5346ef2c35")]
        public global::TlarcRosBridge.Infrastructure.Messages.Std.MultiArrayDimension[] Dim { get; set; }
        ...
        {
            priv.Dim = new global::TlarcRosBridge.Infrastructure.Messages.Std.MultiArrayDimension.PrivSequence(this.Dim.Length);
            var Dim_span = priv.Dim.AsSpan();
            for (int __i = 0; __i < this.Dim.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[std_msgs/msg/MultiArrayDimension[] dim]]></c>
            /// </remarks>
            public global::TlarcRosBridge.Infrastructure.Messages.Std.MultiArrayDimension.PrivSequence Dim;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Std.MultiArrayLayout.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Std.MultiArrayLayout.PrivSequence.{caller}'.");
                }
            }
        }
    }
