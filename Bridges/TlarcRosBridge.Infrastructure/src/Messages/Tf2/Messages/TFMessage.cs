...
namespace TlarcRosBridge.Infrastructure.Messages.Tf2
{
    ...
    public unsafe partial class TFMessage : global::Rosidl.Runtime.IMessage
    {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.4.0+866072750999979fa04a21d1d2f84d5346ef2c35")]
        public TFMessage(
            global::TlarcRosBridge.Infrastructure.Messages.Geometry.TransformStamped[]? @transforms = null
        )
        {
            Transforms = @transforms ?? global::System.Array.Empty<global::TlarcRosBridge.Infrastructure.Messages.Geometry.TransformStamped>();
        }
        ...
        {
            this.Transforms = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.TransformStamped[priv.Transforms.Size];
            var Transforms_span = priv.Transforms.AsSpan();
            for (int __i = 0; __i < this.Transforms.Length; __i++)
            {
                this.Transforms[__i] = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.TransformStamped(in Transforms_span[__i], textEncoding);
            }
        }
        ...
        public TFMessage()
        {
            Transforms = global::System.Array.Empty<global::TlarcRosBridge.Infrastructure.Messages.Geometry.TransformStamped>();
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.4.0+866072750999979fa04a21d1d2f84d5346ef2c35")]
        public global::TlarcRosBridge.Infrastructure.Messages.Geometry.TransformStamped[] Transforms { get; set; }
        ...
        {
            priv.Transforms = new global::TlarcRosBridge.Infrastructure.Messages.Geometry.TransformStamped.PrivSequence(this.Transforms.Length);
            var Transforms_span = priv.Transforms.AsSpan();
            for (int __i = 0; __i < this.Transforms.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/TransformStamped[] transforms]]></c>
            /// </summary>
            public global::TlarcRosBridge.Infrastructure.Messages.Geometry.TransformStamped.PrivSequence Transforms;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Tf2.TFMessage.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::TlarcRosBridge.Infrastructure.Messages.Tf2.TFMessage.PrivSequence.{caller}'.");
                }
            }
        }
    }
