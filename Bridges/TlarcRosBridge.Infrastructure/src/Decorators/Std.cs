...
#region Int
    ...
    public static void FromData(sbyte dataIn, ref Int8.Priv dataOut)
    {
        dataOut.Data = dataIn;
    }

    public static void FromData(byte dataIn, ref UInt8.Priv dataOut)
    {
        dataOut.Data = dataIn;
    }

    public static void FromData(short dataIn, ref Int16.Priv dataOut)
    {
        dataOut.Data = dataIn;
    }

    public static void FromData(ushort dataIn, ref UInt16.Priv dataOut)
    {
        dataOut.Data = dataIn;
    }

    public static void FromData(int dataIn, ref Int32.Priv dataOut)
    {
        dataOut.Data = dataIn;
    }

    public static void FromData(uint dataIn, ref UInt32.Priv dataOut)
    {
        dataOut.Data = dataIn;
    }


    public static void FromData(long dataIn, ref Int64.Priv dataOut)
    {
        dataOut.Data = dataIn;
    }

    public static void FromData(ulong dataIn, ref UInt64.Priv dataOut)
    {
        dataOut.Data = dataIn;
    }
...
#region Float
    ...
    public static void FromData(float dataIn, ref Float32.Priv dataOut)
    {
        dataOut.Data = dataIn;
    }

    public static void FromData(double dataIn, ref Float64.Priv dataOut)
    {
        dataOut.Data = dataIn;
    }
    ...
    public static void FromData(bool dataIn, ref Bool.Priv dataOut)
    {
        dataOut.Data = dataIn;
    }
}
