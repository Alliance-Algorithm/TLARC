...
public static class HikCameraApi
{
  ...
  {
    KinTN.Hardware.HikMachineVisionCamera.MV_ERROR_CODE mV_ERROR_CODE =
      NativeFunction.MV_CC_Initialize();
    if (mV_ERROR_CODE != 0)
    {
      throw new KinTN.Hardware.HikMachineVisionCamera.HikMachineVisionCameraException(
        mV_ERROR_CODE
      );
    }
  }
  ...
  public unsafe static Collection<MV_CC_DEVICE_INFO> EnumerateDevices()
  {
    ...
    KinTN.Hardware.HikMachineVisionCamera.MV_ERROR_CODE mV_ERROR_CODE =
      NativeFunction.MV_CC_EnumDevices(
        KinTN.Hardware.HikMachineVisionCamera.MV_DEVICE_TYPES.MV_USB_DEVICE,
        ref stDevList
      );
    if (mV_ERROR_CODE != 0)
    {
  ...
  public static IntPtr Open(MV_CC_DEVICE_INFO deviceInfo)
  {
    ...
    if (
      !NativeFunction.MV_CC_IsDeviceAccessible(ref deviceInfo, MV_ACCESS_MODE.MV_ACCESS_EXCLUSIVE)
    )
    {
      throw new KinTN.Hardware.HikMachineVisionCamera.HikMachineVisionCameraException(
        KinTN.Hardware.HikMachineVisionCamera.MV_ERROR_CODE.MV_E_ACCESS_DENIED
      );
    }

    KinTN.Hardware.HikMachineVisionCamera.MV_ERROR_CODE mV_ERROR_CODE =
      NativeFunction.MV_CC_CreateHandle(ref handle, ref deviceInfo);
    if (mV_ERROR_CODE != 0)
    {
      throw new KinTN.Hardware.HikMachineVisionCamera.HikMachineVisionCameraException(
        mV_ERROR_CODE
    ...
    mV_ERROR_CODE = NativeFunction.MV_CC_SetEnumValue(handle, "TriggerMode", 0);
    if (mV_ERROR_CODE != 0)
    {
      throw new KinTN.Hardware.HikMachineVisionCamera.HikMachineVisionCameraException(
        mV_ERROR_CODE
  ...
  //   key:
  //     参数名称。
  public static KinTN.Hardware.HikMachineVisionCamera.MV_CC_ENUMENTRY GetEnumValue(
    IntPtr handle,
    string key
  )
  {
    KinTN.Hardware.HikMachineVisionCamera.MV_CC_ENUMENTRY pEnumValue =
      default(KinTN.Hardware.HikMachineVisionCamera.MV_CC_ENUMENTRY);
    KinTN.Hardware.HikMachineVisionCamera.MV_ERROR_CODE mV_ERROR_CODE =
      NativeFunction.MV_CC_GetEnumValue(handle, key, ref pEnumValue);
    if (mV_ERROR_CODE != 0)
    {
      throw new KinTN.Hardware.HikMachineVisionCamera.HikMachineVisionCameraException(
        mV_ERROR_CODE
  ...
  {
    KinTN.Hardware.HikMachineVisionCamera.MV_ERROR_CODE mV_ERROR_CODE =
      NativeFunction.MV_CC_SetEnumValue(handle, key, value);
    if (mV_ERROR_CODE != 0)
    {
      throw new KinTN.Hardware.HikMachineVisionCamera.HikMachineVisionCameraException(
        mV_ERROR_CODE
  ...
  {
    KinTN.Hardware.HikMachineVisionCamera.MV_ERROR_CODE mV_ERROR_CODE =
      NativeFunction.MV_CC_SetCommandValue(handle, command);
    if (mV_ERROR_CODE != 0)
    {
      throw new KinTN.Hardware.HikMachineVisionCamera.HikMachineVisionCameraException(
        mV_ERROR_CODE
  ...
  {
    KinTN.Hardware.HikMachineVisionCamera.MV_ERROR_CODE mV_ERROR_CODE =
      NativeFunction.MV_CC_StartGrabbing(handle);
    if (mV_ERROR_CODE != 0)
    {
      throw new KinTN.Hardware.HikMachineVisionCamera.HikMachineVisionCameraException(
        mV_ERROR_CODE
  ...
  public unsafe static Mat GetImage(IntPtr handle, int timeoutInMilliseconds)
  {
    ...
    KinTN.Hardware.HikMachineVisionCamera.MV_ERROR_CODE mV_ERROR_CODE =
      NativeFunction.MV_CC_GetImageBuffer(handle, ref frame, timeoutInMilliseconds);
    ...
    var converted_data_size_ = frame.stFrameInfo.nWidth * frame.stFrameInfo.nHeight * 3;
  ...
  static unsafe void DisplayStructMemory<T>(ref T str)
    where T : struct
  {
  ...
  {
    KinTN.Hardware.HikMachineVisionCamera.MV_ERROR_CODE mV_ERROR_CODE =
      NativeFunction.MV_CC_StopGrabbing(handle);
    if (mV_ERROR_CODE != 0)
    {
      throw new KinTN.Hardware.HikMachineVisionCamera.HikMachineVisionCameraException(
        mV_ERROR_CODE
  ...
  {
    KinTN.Hardware.HikMachineVisionCamera.MV_ERROR_CODE mV_ERROR_CODE =
      NativeFunction.MV_CC_CloseDevice(handle);
    if (mV_ERROR_CODE != 0)
    {
      throw new KinTN.Hardware.HikMachineVisionCamera.HikMachineVisionCameraException(
        mV_ERROR_CODE
