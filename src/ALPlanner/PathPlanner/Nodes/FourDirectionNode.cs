...
class FourDirectionNode : INode
{
  ...
  public FourDirectionNode(Vector3d position)
  {
    PositionInWorld = position;
  }

  public FourDirectionNode(Vector3d position, FourDirectionNode? parent)
  {
    PositionInWorld = position;
    Parent = parent;
  ...
  public IEnumerable<INode> Children
  {
    get
    {
      ...
      for (int i = 0; i < Headings; i++)
      {
        ...
        children.Add(
          new FourDirectionNode(PositionInWorld + IterationStep * new Vector3d(Cos, Sin, 0), this)
        );
      }
      return children;
    }
