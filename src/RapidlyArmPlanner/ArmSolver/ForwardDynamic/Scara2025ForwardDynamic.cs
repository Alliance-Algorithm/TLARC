...
class Scara2025ForwardDynamic : IForwardDynamic
{
  ...
  public List<(Vector3d pos, Quaterniond rotation)> GetPose(double[] angles)
  {
    ...
    ans.Add(
      (
        new Vector3d(0, 0, (float)angles[1]) + ans[0].rotation * Vector3d.AxisX * 0.15,
        ans[0].rotation
      )
    );
    ...
    ans.Add(
      (
        new Vector3d(0, 0, (float)angles[1])
          + ans[0].rotation * Vector3d.AxisX * 0.3
          + rotation * Vector3d.AxisX * 0.15,
        rotation
      )
    );
    ...
    ans.Add(
      (
        new Vector3d(0, 0, (float)angles[1])
          + ans[0].rotation * Vector3d.AxisX * 0.3
          + ans[2].rotation * Vector3d.AxisX * 0.3
          + rotation * Vector3d.AxisX * 0.025,
        rotation
      )
    );
    ...
    ans.Add(
      (
        new Vector3d(0, 0, (float)angles[1])
          + ans[0].rotation * Vector3d.AxisX * 0.3
          + ans[2].rotation * Vector3d.AxisX * 0.3
          + ans[3].rotation * Vector3d.AxisX * 0.05
          + rotation * Vector3d.AxisX * 0.11,
        rotation
      )
    );
