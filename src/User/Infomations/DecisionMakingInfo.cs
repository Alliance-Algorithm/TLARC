...
namespace AllianceDM.PreInfo
{
    ...
    public class DecisionMakingInfo : Component
    {
        ...
        public float SentryHp => communicators.SentryHp;
        public int BulletCount => communicators.BulletCount;
        public int BulletSupplyCount => communicators.BulletSupplyCount;
        public float DefenseBuff { get; private set; } = 0.6f;
        public float FriendOutPostHp => communicators.FriendOutPostHp;
        public float BaseArmorOpeningCountdown { get; private set; } = 40;
        public bool SupplyRFID => communicators.SupplyRFID;
        public bool PatrolRFID => communicators.PatrolRFID;
