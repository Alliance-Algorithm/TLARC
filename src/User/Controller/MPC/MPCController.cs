...
class MPCController : Component
{
    ...
    override public void Update()
    {
        ...
        // var vel = new Vector2((float)((_u[0] + targetVel.Length()) * Math.Cos(_u[1] + tempAngle - sentry.angle)), (float)((_u[cd0] + targetVel.Length()) * Math.Sin(_u[1] + tempAngle - sentry.angle)));
